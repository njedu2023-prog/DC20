...
state.currentExecutableProfitResearch={status:'ready',kind:'candidate_fixed_ridge',activation:state.candidateProfitActivation.config,projection:{...contract,rows:contract.rows.map((r,i)=>({...r,candidate_rank:i+1,candidate_score:1-i}))}};
